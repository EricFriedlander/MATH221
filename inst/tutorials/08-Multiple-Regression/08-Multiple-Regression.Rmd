...
1. Use the `augment` function to generate a data frame containing a punch of useful information about `births_mod`. Call this new data frame `augmented_mod`.
...
We can still use this formula when doing multiple regression, however we'll see its best to define a different statistic called **adjusted R-squared**:
