...
Choose a dataset from [here](https://www.openintro.org/data/) that interests you, come up with a research questions, and use statistics to analyze the questions. All datasets should be available in the console below:
