...
Suppose that the weight of newborn babies is normally distributed with mean $\mu=7.5$ lbs and standard deviation $0.7$ lbs.
...
What is the probability of a baby weighing less than 7.5 lbs? (You should be able to do this in your head). 

```{r prob-1, exercise=TRUE}

```

What is the probability of a baby weighing less than 6.5 lbs?

```{r prob-2, exercise=TRUE}

```

What is the probability that a new born weighs at least 8 lbs?

```{r prob-3, exercise=TRUE}

```

What is the probability that a new born weights between 7 and 9 lbs?

```{r prob-4, exercise=TRUE}

```

What is the probability that a new born weights between 5.5 and 7 lbs?

```{r prob-5, exercise=TRUE}

```

What is the probability that a new born weight more than 8.5 lbs or less than 5.5 lbs?

```{r prob-6, exercise=TRUE}

```

What is the probability that a new born weight more than 9 lbs or less than 6 lbs?

```{r prob-7, exercise=TRUE}

```

What is the probability that a new born weight more than 9 lbs or less than 5 lbs?
...
Doctors recommend extra screenings for babies predicted to be in the 20% of baby weights that are farthest away from the mean (7.5 lbs). What are the cutoffs for the extra monitoring?
